...
if view_option == 'Upload and Map Data':
    ...
    # data = pd.read_csv(uploaded_file)       # reading the file
    # data.columns = map(str.lower, data.columns)
    # st.session_state['data'] = data      # store of data in session sate
    ...
    if uploaded_file is not None:
        ...
        if 'victims gender' not in data.columns:
...
#region
    ...
    if st.session_state['datum'] is None:
